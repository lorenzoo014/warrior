from Guerreros import Guerreros
...
class Nave():
    def __init__(self, warrior_type, name="Millenium Falcon", crew=1):
        if(not isinstance(crew,int)):
            ...
            raise Guerreros.GuerrerosTypeError("TYPE of GUERREROS WRONG")
    ...
    def get_shot(self,shot):
        ...
        for i in range(0,len(self.__crew)):
            ...
            raise Guerreros.GuerrerosTypeError("TYPE of GUERREROS WRONG in the crew " + self.__crew)
